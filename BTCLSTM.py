# -*- coding: utf-8 -*-
"""
Created on Sun May 30 12:38:23 2021
...
model_lstm = tf.keras.models.Sequential([
    tf.keras.layers.LSTM(250, return_sequences= True, input_shape = (X_train.shape[1], X_train.shape[2])),
...
history = model_lstm.fit(X_train, y_train, epochs = 100, validation_data=(X_valid, y_valid))
